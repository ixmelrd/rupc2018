...
void case_50_small() {
  rep(num, 10) {
    ...
    output(N, M, s, t, a, b, c, "50_small", num);
  }
}
...
void case_52_Mmin() {
  rep(num, 10) {
    ...
    vector<int> a, b, c;
    gen_random(N, M, s, t, a, b, c);
    output(N, M, s, t, a, b, c, "52_Mmin", num);
  }
}
...
void case_52_Nmin() {
  rep(num, 10) {
    ...
    vector<int> a, b, c;
    gen_random(N, M, s, t, a, b, c);
    output(N, M, s, t, a, b, c, "52_Nmin", num);
  }
}
...
void case_52_Nmin_Mmin() {
  rep(num, 10) {
    ...
    vector<int> a, b, c;
    gen_random(N, M, s, t, a, b, c);
    output(N, M, s, t, a, b, c, "52_Nmin_Mmin", num);
  }
}
...
void case_53_Mmax() {
  rep(num, 10) {
    ...
    vector<int> a, b, c;
    gen_random(N, M, s, t, a, b, c);
    output(N, M, s, t, a, b, c, "53_Mmax", num);
  }
}
...
void case_53_Nmax() {
  rep(num, 10) {
    ...
    vector<int> a, b, c;
    gen_random(N, M, s, t, a, b, c);
    output(N, M, s, t, a, b, c, "53_Nmax", num);
  }
}
...
void case_53_Nmax_Mmax() {
  rep(num, 10) {
    ...
    vector<int> a, b, c;
    gen_random(N, M, s, t, a, b, c);
    output(N, M, s, t, a, b, c, "53_Nmax_Mmax", num);
  }
}
...
void case_60_complete_graph() {
  rep(num, 10) {
    ...
    output(N, M, s, t, a, b, c, "60_complete_graph", num);
  }
}
...
void case_60_path_graph() {
  rep(num, 10) {
    ...
    output(N, M, s, t, a, b, c, "60_path_graph", num);
  }
}
...
void case_60_star_graph() {
  rep(num, 10) {
    ...
    output(N, M, s, t, a, b, c, "60_star_graph", num);
  }
}
...
void case_60_tree_graph() {
  rep(num, 10) {
    ...
    output(N, M, s, t, a, b, c, "60_tree_graph", num);
  }
}
